...
const budgetScreens = {
  transferegov: {
    title: "02 - Campos TRANSFERE.GOV",
    subtitle: "Estrutura revisada para cadastro das metas e etapas no TRANSFERE.GOV, com descrições no limite operacional exigido.",
    file: "campos_transferegov.md"
  },
  pad: {
    title: "03 - PAD",
